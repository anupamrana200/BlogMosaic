        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center space-x-3">
              <Logo width="60px" />
              <span className="text-2xl font-bold text-white">BlogMosaic</span>
            </div>
            <p className="text-slate-300 text-lg leading-relaxed max-w-md">
              A beautiful platform for sharing stories, ideas, and connecting with a community of passionate writers.
            </p>
            <div className="flex space-x-4">
              {/* Social Media Icons */}
              <a href="#" className="p-2 bg-slate-800 rounded-lg hover:bg-indigo-600 transition-colors duration-200">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  ...
                  to="/"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-200">Affiliate Program</span>
                </Link>
              </li>
              <li>
                <Link
                  ...
                  to="/"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-200">Press Kit</span>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  ...
                  to="/"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-200">Account</span>
                </Link>
              </li>
              <li>
                <Link
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  ...
                  to="/"
                >
                  <span className="group-hover:translate-x-1 transition-transform duration-200">Licensing</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-400 text-sm">
              &copy; {new Date().getFullYear()} BlogMosaic. All Rights Reserved.
            </p>
